...
print("     excludes any detectable residue AT THE CANONICAL BUDGET. W3 update")
print("     (2026-09-25): the exemption is BUDGET-LIMITED, not absolute — LIMEN")
print("     `limen_d_crit_price.py` measures the crossing bracket X* in")
print("     [1.97e7, 2.36e7] walker-steps (10-12x canonical; analytic 8.2x) where")
print("     d_det = 0.00194 <= d_crit: one decade of extra budget makes the notch")
print("     residue DETECTABLE. The no-go is an economic statement, not a law.")
print("     Conversely a residue-REAL correction")
